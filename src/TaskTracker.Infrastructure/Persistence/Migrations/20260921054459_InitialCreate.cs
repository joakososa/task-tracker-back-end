        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TaskItems_Priority", "[Priority] IN ('Low', 'Medium', 'High')");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskItems_TaskStates_State",
                        column: x => x.State,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_TaskItemId_CreatedAt",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_ProjectId_State",
                table: "TaskItems",
                columns: new[] { "ProjectId", "State" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_State",
                table: "TaskItems",
                column: "State");
